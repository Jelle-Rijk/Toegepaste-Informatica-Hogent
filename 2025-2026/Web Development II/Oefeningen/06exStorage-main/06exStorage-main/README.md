...
- Voeg code toe aan de methode `#addMilestone`:
  ...
  - Als de `date` kleiner is of gelijk is aan vandaag, gooit de functie een `Error` met de foutmelding _"This milestone is in the past and wasn't added."_
...
Vanaf nu zou je Milestones moeten kunnen toevoegen en komt de nieuwe in de lijst van milestones aan de rechterzijde.
