...
public class VertoonbaarApplicatie {
	...
	private void voegVoorstellingToe() {
		...
		} catch (NumberFormatException e) {System.out.println("Aantal sterren en jaar moet een geheel getal zijn.");}
		catch (Exception e) {
	...
	private String[] geefKeuzeMenu(int nrMenu) {
		String[][] menu = {
				{ "Toon het overzicht van de voorstellingen", "Voeg een voorstelling toe",
